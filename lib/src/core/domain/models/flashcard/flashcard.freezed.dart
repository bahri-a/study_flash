...
mixin _$Flashcard {
 ...
 String get id; String get topicId; String get frontText; String get backText; bool get isLearned; DateTime get nextReview; int get reviewCount;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,topicId,frontText,backText,isLearned,nextReview,reviewCount);

@override
String toString() {
  return 'Flashcard(id: $id, topicId: $topicId, frontText: $frontText, backText: $backText, isLearned: $isLearned, nextReview: $nextReview, reviewCount: $reviewCount)';
}
...
@useResult
$Res call({
 String id, String topicId, String frontText, String backText, bool isLearned, DateTime nextReview, int reviewCount
});
...
/// Create a copy of Flashcard
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? topicId = null,Object? frontText = null,Object? backText = null,Object? isLearned = null,Object? nextReview = null,Object? reviewCount = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String topicId,  String frontText,  String backText,  bool isLearned,  DateTime nextReview,  int reviewCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Flashcard() when $default != null:
return $default(_that.id,_that.topicId,_that.frontText,_that.backText,_that.isLearned,_that.nextReview,_that.reviewCount);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String topicId,  String frontText,  String backText,  bool isLearned,  DateTime nextReview,  int reviewCount)  $default,) {final _that = this;
switch (_that) {
case _Flashcard():
return $default(_that.id,_that.topicId,_that.frontText,_that.backText,_that.isLearned,_that.nextReview,_that.reviewCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String topicId,  String frontText,  String backText,  bool isLearned,  DateTime nextReview,  int reviewCount)?  $default,) {final _that = this;
switch (_that) {
case _Flashcard() when $default != null:
return $default(_that.id,_that.topicId,_that.frontText,_that.backText,_that.isLearned,_that.nextReview,_that.reviewCount);case _:
  return null;
...
class _Flashcard implements Flashcard {
  const _Flashcard({required this.id, required this.topicId, required this.frontText, required this.backText, this.isLearned = false, required this.nextReview, this.reviewCount = 0});
  factory _Flashcard.fromJson(Map<String, dynamic> json) => _$FlashcardFromJson(json);

@override final  String id;
@override final  String topicId;
@override final  String frontText;
@override final  String backText;
...
/// Create a copy of Flashcard
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? topicId = null,Object? frontText = null,Object? backText = null,Object? isLearned = null,Object? nextReview = null,Object? reviewCount = null,}) {
